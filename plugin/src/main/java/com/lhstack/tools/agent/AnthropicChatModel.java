...
public class AnthropicChatModel extends ChatModelBase {
    ...
    public AnthropicChatModel(
        ...
        if (state.getProxyEnabled()) {
            Proxy.Type type = Proxy.Type.HTTP;
            if(AgentProxyType.fromId(state.getProxyType()) == AgentProxyType.SOCKS){
                type = Proxy.Type.SOCKS;
            }
            clientBuilder.proxy(new Proxy(type, new InetSocketAddress(state.getProxyHost(), state.getProxyPort())));
        }
    ...
    public static class Builder {
        ...
        private AgentProviderState state;

        public Builder agentProviderState(AgentProviderState state) {
            this.state = state;
            return this;
        }
        ...
        public AnthropicChatModel build() {
            return new AnthropicChatModel(
                    baseUrl, apiKey, modelName, streamEnabled, defaultOptions, formatter,state);
        }
    }
}
