...
class CliTool(
    ...
    private val COMMANDS: List<Triple<String, String, JsonObject>> by lazy {
        ...
        listOf(
            ...
            Triple("model.create", "创建模型。", props("provider_id" to field("integer", true, "供应商 ID"), "alias" to field("string", true, "模型别名"), "model_id" to field("string", true, "远端模型 ID"), "modalities" to field("array<string>", false, "能力列表"), "model_params" to field("object", false, "模型参数"), "execution_params" to field("object", false, "执行参数，可含 history_token_ratio"), "additional_params" to field("object", false, "附加参数"))),
            Triple("model.update", "更新模型，未传字段保持不变。", props("id" to field("integer", true, "模型 ID"), "provider_id" to field("integer", false, "供应商 ID"), "alias" to field("string", false, "模型别名"), "model_id" to field("string", false, "远端模型 ID"), "display_name" to field("string|null", false, "显示名"), "api" to field("string|null", false, "responses/completions"), "context_window" to field("integer|null", false, "上下文窗口"), "modalities" to field("array<string>", false, "能力列表"), "model_params" to field("object|null", false, "模型参数"), "execution_params" to field("object|null", false, "执行参数，可含 history_token_ratio"), "additional_params" to field("object|null", false, "附加参数"), "enabled" to field("boolean", false, "是否启用"))),
