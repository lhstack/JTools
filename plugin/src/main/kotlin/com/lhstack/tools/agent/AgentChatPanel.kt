...
class AgentChatPanel(private val project: Project) : SimpleToolWindowPanel(true, true), com.intellij.openapi.Disposable {
    ...
    private fun visibleSessions(): List<ChatSessionRecord> {
        if (!AgentDatabase.isReady()) return emptyList()
        return ChatSessionService.listVisibleSessions(currentProjectPath())
    }
    ...
    internal data class AgentBrowserState(
    ...
    internal data class AgentBrowserFileContextChip(
    ...
    internal data class AgentBrowserFileContextItem(
        @SerializedName("path") val path: String,
        @SerializedName("startLine") val startLine: Int?,
        @SerializedName("endLine") val endLine: Int?,
    )
    internal data class AgentBrowserInputRestore(
        @SerializedName("sequence") val sequence: Long,
        @SerializedName("text") val text: String,
    )
    internal data class AgentBrowserTheme(
